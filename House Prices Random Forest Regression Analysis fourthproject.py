...
train = pd.read_csv(r'D:\ds\kaggle\House Prices Random Forest Regression Analysis/train.csv')
train_original = pd.read_csv(r'D:\ds\kaggle\House Prices Random Forest Regression Analysis/train.csv')
test = pd.read_csv(r'D:\ds\kaggle\House Prices Random Forest Regression Analysis/test.csv')
train.info()
...
train = pd.read_csv(r'D:\ds\kaggle\House Prices Random Forest Regression Analysis/train.csv')  # get the training data again just in case
train['SalePrice'] = np.log(train['SalePrice'])
